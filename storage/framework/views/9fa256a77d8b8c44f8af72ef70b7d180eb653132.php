        ...
        <script>
            ...
            firebase.initializeApp(firebaseConfig);
                ...
                function initFirebaseMessagingRegistration() {
                        ...
                        .requestPermission()
                        .then(function () {
                            return messaging.getToken({ vapidKey: "<?php echo e(config('server_credentials.fcm_project_key')); ?>" })
                        })
                        .then(function(token) {
                            $.ajaxSetup({
                                headers: {
                            ...
                            $.ajax({
                                url: '<?php echo e(route("SavePNToken")); ?>',
                                type: 'POST',
                                data: {
                                    token: token
                                },
                ...
                messaging.onMessage(function(payload) {
                    ...
                    if (payload.data.end_call != undefined  && payload.data.end_call != '' && payload.data.end_call == '1') {
                        disconnectCall(noteTitle, noteOptions);

                    } else {
                        notifyMe(noteTitle, noteOptions, payload.data.room_name);

                    }
                });

                function disconnectCall(text, noteOptions) {
                ...
                function notifyMe(text, noteOptions, roomName) {
                    if (Notification.permission !== "granted")
                        Notification.requestPermission();
                    else {
                        var notification = new Notification(text, {               
                        ...
                        notification.addEventListener("click", function (event) {
                            var url = '';
                            var newUrl =  url + '?room_name=' +roomName
                ...
                $.ajax({
                    url: '<?php echo e(route("CheckToken")); ?>',
                    type: 'GET',
                    success: function (response) {
                    },
                    error: function (err) {
...
<?php /**PATH C:\xampp\htdocs\DuckybankBackEnd\resources\views/welcome.blade.php ENDPATH**/ ?>